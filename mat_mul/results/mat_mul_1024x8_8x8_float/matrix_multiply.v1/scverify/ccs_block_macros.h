...
#define ccs_intercept_matrix_multiply_3 \
  matrix_multiply(ac_ieee_float<binary16> A[1024][8], ac_ieee_float<binary16> B[8][8], ac_ieee_float<binary16> C[1024][8]);\
  extern void mc_testbench_capture_IN( ac_ieee_float<binary16> A[1024][8], ac_ieee_float<binary16> B[8][8], ac_ieee_float<binary16> C[1024][8] );\
  extern void mc_testbench_capture_OUT( ac_ieee_float<binary16> A[1024][8], ac_ieee_float<binary16> B[8][8], ac_ieee_float<binary16> C[1024][8] );\
  void ccs_real_matrix_multiply(ac_ieee_float<binary16> A[1024][8], ac_ieee_float<binary16> B[8][8], ac_ieee_float<binary16> C[1024][8]);\
  void matrix_multiply(ac_ieee_float<binary16> A[1024][8], ac_ieee_float<binary16> B[8][8], ac_ieee_float<binary16> C[1024][8])\
  {\
