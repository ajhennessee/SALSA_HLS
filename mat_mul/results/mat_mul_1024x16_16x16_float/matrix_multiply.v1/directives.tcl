...
solution options set /Input/CompilerFlags {-DNd=1024 -DMd=16 -DPd=16 -DTYPE_T=my_float_t}
...
solution file add ./src/mat_mul.h -type CHEADER -exclude true
...
directive set /matrix_multiply/A.d:rsc -INTERLEAVE 16
directive set /matrix_multiply/B.d:rsc -BLOCK_SIZE 16
