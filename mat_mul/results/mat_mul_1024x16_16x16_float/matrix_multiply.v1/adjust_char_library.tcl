...
library set /LIBS/saed32lvt_tt0p78v125c_beh/MODS/mgc_mul/PARAMETERS/signd_a -- -CHAR_RANGE {0, 1 to 1}
library set /LIBS/saed32lvt_tt0p78v125c_beh/MODS/mgc_mul/PARAMETERS/signd_b -- -CHAR_RANGE {0, 1 to 1}
library set /LIBS/saed32lvt_tt0p78v125c_beh/MODS/mgc_mul_pipe/PARAMETERS/signd_a -- -CHAR_RANGE {0, 1 to 1}
library set /LIBS/saed32lvt_tt0p78v125c_beh/MODS/mgc_mul_pipe/PARAMETERS/signd_b -- -CHAR_RANGE {0, 1 to 1}
...
library set /LIBS/saed32lvt_tt0p78v125c_beh/MODS/mgc_nor/PARAMETERS/ninps -- -CHAR_RANGE {2 to 2, 4 to 32, 88}
