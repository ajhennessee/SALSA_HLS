...
public:
   ...
   public:
      void capture_B( ac_ieee_float<binary16 > B[16][8]) ;
   public:
      void capture_C( ac_ieee_float<binary16 > C[1024][8]) ;
   protected:
      void wait_on_input_required() ;
   public:
      static void capture_IN(ac_ieee_float<binary16> A[1024][16], ac_ieee_float<binary16> B[16][8], ac_ieee_float<binary16> C[1024][8]) ;
   public:
      static void capture_OUT(ac_ieee_float<binary16> A[1024][16], ac_ieee_float<binary16> B[16][8], ac_ieee_float<binary16> C[1024][8]) ;
   public:
      static void exec_matrix_multiply(ac_ieee_float<binary16> A[1024][16], ac_ieee_float<binary16> B[16][8], ac_ieee_float<binary16> C[1024][8]) ;
   protected:
