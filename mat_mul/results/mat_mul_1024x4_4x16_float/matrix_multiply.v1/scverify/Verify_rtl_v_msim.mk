...
#   SOLUTION_DIR  /home/ajh9498/Documents/SALSA_HLS/mat_mul/mat_mul_1024x4_4x16_float/matrix_multiply.v1
#   WORKING_DIR   /home/ajh9498/Documents/SALSA_HLS/mat_mul/mat_mul_1024x4_4x16_float/matrix_multiply.v1/.
...
WORK2PROJ = ../..
WORK2SOLN = .
PROJ2WORK = ./mat_mul_1024x4_4x16_float/matrix_multiply.v1
PROJ2SOLN = ./mat_mul_1024x4_4x16_float/matrix_multiply.v1
export WORK_DIR
export WORK2PROJ
export WORK2SOLN
export PROJ2WORK
...
RTL_NETLIST_FNAME           = /home/ajh9498/Documents/SALSA_HLS/mat_mul/mat_mul_1024x4_4x16_float/matrix_multiply.v1/rtl.v
endif
...
TOP_DU                   := scverify_top
CXX_TYPE                 := gcc
MSIM_SCRIPT              := ./mat_mul_1024x4_4x16_float/matrix_multiply.v1/scverify_msim.tcl
...
CXXFLAGS += -DNd=1024 -DMd=4 -DPd=16 -DTYPE_T=my_float_t -DCCS_SCVERIFY -DSC_INCLUDE_DYNAMIC_PROCESSES -DSC_USE_STD_STRING -DTOP_HDL_ENTITY=$(TOP_HDL_ENTITY) -DCCS_DESIGN_FUNC_matrix_multiply -DCCS_DESIGN_TOP_$(TOP_HDL_ENTITY) -DCCS_MISMATCHED_OUTPUTS_ONLY $(F_WRAP_OPT)
# 
