...
library set /LIBS/saed32lvt_tt0p78v125c_beh/MODS/mgc_mux1hot/PARAMETERS/ctrlw -- -CHAR_RANGE {2 to 2, 4 to 32, 76}
library set /LIBS/saed32lvt_tt0p78v125c_beh/MODS/mgc_or/PARAMETERS/ninps -- -CHAR_RANGE {2 to 2, 4 to 32, 44}
