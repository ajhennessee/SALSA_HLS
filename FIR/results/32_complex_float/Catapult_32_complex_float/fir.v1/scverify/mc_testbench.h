...
public:
   ...
   sc_port< tlm::tlm_fifo_put_if< mgc_sysc_ver_array1D<ac_fixed<11, 1, true, AC_TRN, AC_WRAP >,32> > > ccs_taps_real_m;
   sc_port< tlm::tlm_fifo_put_if< mc_wait_ctrl > > ccs_wait_ctrl_taps_real_m;
   sc_port< tlm::tlm_fifo_put_if< mgc_sysc_ver_array1D<ac_int<5, true >,32> > > ccs_taps_real_e;
   sc_port< tlm::tlm_fifo_put_if< mc_wait_ctrl > > ccs_wait_ctrl_taps_real_e;
   sc_port< tlm::tlm_fifo_put_if< mgc_sysc_ver_array1D<ac_fixed<11, 1, true, AC_TRN, AC_WRAP >,32> > > ccs_taps_imag_m;
   sc_port< tlm::tlm_fifo_put_if< mc_wait_ctrl > > ccs_wait_ctrl_taps_imag_m;
   sc_port< tlm::tlm_fifo_put_if< mgc_sysc_ver_array1D<ac_int<5, true >,32> > > ccs_taps_imag_e;
   ...
   public:
      void capture_taps( my_complex_float_t taps[32]) ;
   public:
      void capture__TOP__return(my_complex_float_t _TOP__return) ;
   protected:
      void wait_on_input_required() ;
   public:
      static void capture_IN(my_complex_float_t input, my_complex_float_t taps[32]) ;
   public:
      static void capture_OUT(my_complex_float_t _TOP__return, my_complex_float_t input, my_complex_float_t taps[32]) ;
   public:
