...
#define ccs_intercept_fir_3 \
  fir(my_complex_float_t input, my_complex_float_t taps[32]);\
  extern void mc_testbench_capture_IN( my_complex_float_t input, my_complex_float_t taps[32] );\
  extern void mc_testbench_capture_OUT( my_complex_float_t _retvalue, my_complex_float_t input, my_complex_float_t taps[32] );\
  my_complex_float_t ccs_real_fir(my_complex_float_t input, my_complex_float_t taps[32]);\
  my_complex_float_t fir(my_complex_float_t input, my_complex_float_t taps[32])\
  {\
