...
public:
  ...
  sc_signal<sc_lv<704> >                                                                         TLS_taps_m_rsc_dat;
  sc_signal<sc_logic>                                                                            TLS_taps_m_triosy_lz;
  sc_signal<sc_lv<320> >                                                                         TLS_taps_e_rsc_dat;
  ...
  ccs_in_trans_rsc_v1<1,704 >                                                                    taps_m_rsc_INST;
  ccs_in_trans_rsc_v1<1,320 >                                                                    taps_e_rsc_INST;
  ...
  tlm::tlm_fifo<mgc_sysc_ver_array1D<ac_fixed<11, 1, true, AC_TRN, AC_WRAP >,64> >               TLS_in_fifo_taps_m;
  tlm::tlm_fifo<mc_wait_ctrl>                                                                    TLS_in_wait_ctrl_fifo_taps_m;
  mc_trios_input_monitor                                                                         trios_monitor_taps_m_triosy_lz_INST;
  mc_input_transactor<mgc_sysc_ver_array1D<ac_fixed<11, 1, true, AC_TRN, AC_WRAP >,64>,11,true>  transactor_taps_m;
  tlm::tlm_fifo<mgc_sysc_ver_array1D<ac_int<5, true >,64> >                                      TLS_in_fifo_taps_e;
  tlm::tlm_fifo<mc_wait_ctrl>                                                                    TLS_in_wait_ctrl_fifo_taps_e;
  mc_trios_input_monitor                                                                         trios_monitor_taps_e_triosy_lz_INST;
  mc_input_transactor<mgc_sysc_ver_array1D<ac_int<5, true >,64>,5,true>                          transactor_taps_e;
  ...
  scverify_top(const sc_module_name& name)
    ...
    , transactor_taps_m("transactor_taps_m", 0, 704, 0, d_disable_on_empty)
    ...
    , transactor_taps_e("transactor_taps_e", 0, 320, 0, d_disable_on_empty)
    ...
    , sync_generator_INST("sync_generator", true, false, false, false, 259, 259, 0)
    , catapult_monitor_INST("Monitor", clk, true, 259LL, 259LL)
