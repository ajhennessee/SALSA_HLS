...
extern "C++" ac_float<11, 1, 5, AC_TRN > fir(ac_float<11, 1, 5, AC_TRN> input, ac_float<11, 1, 5, AC_TRN> taps[64]);
#endif
#ifndef CCS_SCVERIFY_USE_CCS_BLOCK
ac_float<11, 1, 5, AC_TRN> testbench::exec_fir(ac_float<11, 1, 5, AC_TRN> input, ac_float<11, 1, 5, AC_TRN> taps[64]) {
...
void mc_testbench::capture_taps( ac_float<11, 1, 5, AC_TRN > taps[64])
{
   ...
   if (_capture_taps_m && !testbench::taps_m_ignore)
   {
      ...
      mgc_sysc_ver_array1D<ac_fixed<11, 1, true, AC_TRN, AC_WRAP >,64> taps_m_tmp;
      int taps_linear_idx = 0;
      for (int taps_idx_0 = 0; taps_idx_0 < 64; ++taps_idx_0)
   ...
   if (_capture_taps_e && !testbench::taps_e_ignore)
   {
      ...
      mgc_sysc_ver_array1D<ac_int<5, true >,64> taps_e_tmp;
      int taps_linear_idx = 0;
      for (int taps_idx_0 = 0; taps_idx_0 < 64; ++taps_idx_0)
...
void mc_testbench::capture_IN(ac_float<11, 1, 5, AC_TRN> input, ac_float<11, 1, 5, AC_TRN> taps[64])
{
...
void mc_testbench::capture_OUT(ac_float<11, 1, 5, AC_TRN> _TOP__return, ac_float<11, 1, 5, AC_TRN> input, ac_float<11, 1, 5, AC_TRN> taps[64])
{
...
ac_float<11, 1, 5, AC_TRN> mc_testbench::exec_fir(ac_float<11, 1, 5, AC_TRN> input, ac_float<11, 1, 5, AC_TRN> taps[64])
{
   #ifndef CCS_SCVERIFY_USE_CCS_BLOCK
   wait_for_idle_sync();
