...
#define ccs_intercept_fir_3 \
  fir(ac_float<11, 1, 5, AC_TRN> input, ac_float<11, 1, 5, AC_TRN> taps[32]);\
  extern void mc_testbench_capture_IN( ac_float<11, 1, 5, AC_TRN> input, ac_float<11, 1, 5, AC_TRN> taps[32] );\
  extern void mc_testbench_capture_OUT( ac_float<11, 1, 5, AC_TRN> _retvalue, ac_float<11, 1, 5, AC_TRN> input, ac_float<11, 1, 5, AC_TRN> taps[32] );\
  ac_float<11, 1, 5, AC_TRN> ccs_real_fir(ac_float<11, 1, 5, AC_TRN> input, ac_float<11, 1, 5, AC_TRN> taps[32]);\
  ac_float<11, 1, 5, AC_TRN> fir(ac_float<11, 1, 5, AC_TRN> input, ac_float<11, 1, 5, AC_TRN> taps[32])\
  {\
